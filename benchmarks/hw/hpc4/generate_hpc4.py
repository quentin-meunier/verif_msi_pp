...
def usage():
    ...
    print('')
    print('[1] Gaëtan Cassiers, François-Xavier Standaert and Corentin Verhamme (2024). Low-Latency Masked Gadgets Robust against Physical Defaults with Application to Ascon.')
 ...
 * See https://www.gnu.org/licenses/gpl-3.0.en.html for license information
 * SPDX-License-Identifier: GPL-3.0-only
 * File generated by generate_hpc4.py
 */

/* gadget comes from the article 
 * https://tches.iacr.org/index.php/TCHES/article/view/11689/11209
 */
