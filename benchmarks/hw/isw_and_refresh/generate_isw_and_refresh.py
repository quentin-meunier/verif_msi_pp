...
def generate_isw_and_refresh(*argv):
    ...
    gadget.description_file = "   This script contains a VerifMSI++ description of a circuit implementing the logical AND following the ISW scheme with share refreshing from [1] with %d shares." % (gadget.nbShares)
